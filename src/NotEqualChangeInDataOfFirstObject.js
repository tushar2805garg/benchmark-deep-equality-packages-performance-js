...
import { generateDifftDataAtFirstPos } from "./App";

const orders = generateDifftDataAtFirstPos(5000);
const orders1 = generateDifftDataAtFirstPos(5000);
...
export const NotEqualChangeInDataOfFirstObject = () => { }
